...
class FractureAE(pl.LightningModule):
    ...
    def forward(self, data_dict):
        ...
        part_normals = data_dict.get('part_normals', None)
        ...
        if part_normals is not None:
            part_normals = part_normals[mask]
            data_dict['part_normals'] = part_normals
        if part_locdists is not None:
            part_locdists = part_locdists[mask]
            data_dict['part_locdists'] = part_locdists
