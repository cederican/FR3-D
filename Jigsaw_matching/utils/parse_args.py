...
def generate_output_path(model_name):
    output_path = os.path.join("/home/cederic/dev/puzzlefusion-plusplus/Jigsaw_matching/results", model_name)
    model_save_path = os.path.join("/home/cederic/dev/puzzlefusion-plusplus/Jigsaw_matching/results", model_name, "model_save")
